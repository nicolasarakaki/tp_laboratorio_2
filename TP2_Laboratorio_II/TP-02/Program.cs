...
namespace TP_02_2020
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Nombre del alumno
            Console.Title = "Nicolas Arakaki 2°D";
            ...
            taller -= c1;
            taller -= new Ciclomotor(Vehiculo.EMarca.Honda, "ASD913", ConsoleColor.Red); //no se quita porque no existe en taller
            ...
            // Vuelvo a agregar c2
            taller += c2; // no se agrega porque ya estaba agregado
